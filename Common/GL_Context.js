...
var texture_filenames_to_load = [ "stars.png", "text.png", "earth.gif","paper2.png", "crosshairdiamond.png",
"plaid.png", "paused.png" , "chevron.png","diamonds.png","floral.png","hexes.png","palms.png", "poca.png",
"redcon.png","silk.png","tree.png","vintage.png", "sky.png","ricepaper.png"];
...
{	this.string_map = { };	this.m_text = new text_line( 20 ); 		this.start_index = 2;	this.tick = 0;
	...
	Debug_Screen.prototype.display = function(time)
	{
			...
			for( var i = 0, idx = this.start_index; i < 7 && i < strings.length; i++, idx = (idx + 1) % strings.length )
			{
